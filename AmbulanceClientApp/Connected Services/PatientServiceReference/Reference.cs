...
namespace AmbulanceClientApp.PatientServiceReference {
    ...
    public interface IPatientService {
        ...
        AmbulanceClientApp.PatientServiceReference.PatientDataContract[] GetAllPatients();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPatientService/GetAllPatients", ReplyAction="http://tempuri.org/IPatientService/GetAllPatientsResponse")]
        System.Threading.Tasks.Task<AmbulanceClientApp.PatientServiceReference.PatientDataContract[]> GetAllPatientsAsync();
        ...
        AmbulanceClientApp.PatientServiceReference.PatientDataContract GetPatient(string patientId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPatientService/GetPatient", ReplyAction="http://tempuri.org/IPatientService/GetPatientResponse")]
        System.Threading.Tasks.Task<AmbulanceClientApp.PatientServiceReference.PatientDataContract> GetPatientAsync(string patientId);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IPatientServiceChannel : AmbulanceClientApp.PatientServiceReference.IPatientService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class PatientServiceClient : System.ServiceModel.ClientBase<AmbulanceClientApp.PatientServiceReference.IPatientService>, AmbulanceClientApp.PatientServiceReference.IPatientService {
        ...
        public AmbulanceClientApp.PatientServiceReference.PatientDataContract[] GetAllPatients() {
            return base.Channel.GetAllPatients();
        }
        
        public System.Threading.Tasks.Task<AmbulanceClientApp.PatientServiceReference.PatientDataContract[]> GetAllPatientsAsync() {
            return base.Channel.GetAllPatientsAsync();
        }
        
        public AmbulanceClientApp.PatientServiceReference.PatientDataContract GetPatient(string patientId) {
            return base.Channel.GetPatient(patientId);
        }
        
        public System.Threading.Tasks.Task<AmbulanceClientApp.PatientServiceReference.PatientDataContract> GetPatientAsync(string patientId) {
