...
namespace HeadOfficeClientApplication.CalloutServiceReference {
    ...
    public interface ICallOutService {
        ...
        HeadOfficeClientApplication.CalloutServiceReference.CallOutDataContract[] GetAllCallOuts();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICallOutService/GetAllCallOuts", ReplyAction="http://tempuri.org/ICallOutService/GetAllCallOutsResponse")]
        System.Threading.Tasks.Task<HeadOfficeClientApplication.CalloutServiceReference.CallOutDataContract[]> GetAllCallOutsAsync();
        ...
        HeadOfficeClientApplication.CalloutServiceReference.CallOutDataContract GetCallOut(string callOutId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICallOutService/GetCallOut", ReplyAction="http://tempuri.org/ICallOutService/GetCallOutResponse")]
        System.Threading.Tasks.Task<HeadOfficeClientApplication.CalloutServiceReference.CallOutDataContract> GetCallOutAsync(string callOutId);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ICallOutServiceChannel : HeadOfficeClientApplication.CalloutServiceReference.ICallOutService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CallOutServiceClient : System.ServiceModel.ClientBase<HeadOfficeClientApplication.CalloutServiceReference.ICallOutService>, HeadOfficeClientApplication.CalloutServiceReference.ICallOutService {
        ...
        public HeadOfficeClientApplication.CalloutServiceReference.CallOutDataContract[] GetAllCallOuts() {
            return base.Channel.GetAllCallOuts();
        }
        
        public System.Threading.Tasks.Task<HeadOfficeClientApplication.CalloutServiceReference.CallOutDataContract[]> GetAllCallOutsAsync() {
            return base.Channel.GetAllCallOutsAsync();
        }
        
        public HeadOfficeClientApplication.CalloutServiceReference.CallOutDataContract GetCallOut(string callOutId) {
            return base.Channel.GetCallOut(callOutId);
        }
        
        public System.Threading.Tasks.Task<HeadOfficeClientApplication.CalloutServiceReference.CallOutDataContract> GetCallOutAsync(string callOutId) {
